    ...
    <article>
        <div class="add-show-form-wrapper">
            <form class="form-horizontal adding-form" accept-charset="UTF-8" enctype="multipart/form-data"
                  data-toggle="validator" role="form" id="addMovieForm"
                  action="${pageContext.request.contextPath}/upload?command=add_movie" method="post">

                <c:import url="/WEB-INF/jsp/show/addShowForm.jsp"/>
                <c:import url="/WEB-INF/jsp/movie/movieInfoForm.jsp"/>
