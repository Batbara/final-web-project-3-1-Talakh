...
<fmt:message bundle="${loc}" key="local.user.administration.page" var="title"/>
...
<fmt:message bundle="${loc}" key="local.admin.user.table.name" var="usernameHeader"/>
<fmt:message bundle="${loc}" key="local.admin.user.table.status" var="statusHeader"/>
