...
import by.tr.web.dao.exception.TableConfigurationError;
import by.tr.web.service.table.TableConfigurationException;
...
public class ServletContextInitializer implements ServletContextListener {
    ...
    private void initializeTableConfiguration() {
        TableConfigurationFactory factory = TableConfigurationFactory.getInstance();
        try {
            factory.initFactory();
        } catch (TableConfigurationException e) {
            logger.log(Level.FATAL, "Failed to init table configuration", e);
            throw new TableConfigurationError("Failed to init table configuration");
        }
    }
