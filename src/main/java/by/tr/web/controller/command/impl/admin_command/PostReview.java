...
public class PostReview implements Command {

    private static final Logger logger = Logger.getLogger(PostReview.class);
    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            UserReview reviewToPost = showService.retrieveUserReview(request);

            showService.postUserReview(reviewToPost);
