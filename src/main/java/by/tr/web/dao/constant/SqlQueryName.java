...
public final class SqlQueryName {
    ...
    public static final String ADD_NEW_TV_SHOW = "tv.add.new.tv.show";
    public static final String ADD_TV_SHOW_FINISHED_YEAR = "tv.add.finished.year";
    ...
    public static final String CHECK_SHOW_EXISTENCE_IN_DB  = "show.check.show.existence";
    public static final String CHECK_SHOW_EXISTENCE_BY_ID = "show.check.show.by.id";
    public static final String COUNT_ALL_SHOWS_QUERY = "show.count.shows";
    ...
    public static final String ADD_SHOW_POSTER = "show.add.poster";
    ...
    public static final String DELETE_SHOW = "show.delete.show";
    public static final String TAKE_SHOWS_LIST = "show.take.shows.list";
