...
public class MovieDAOImplTest {
    ...
    public void testMoviesOrderedByYear() throws DAOException {
        ...
        String lang = "en";
        String orderType = MovieValidator.OrderType.YEAR.toString();

        List<Movie> actualMovieList = movieDAO.takeOrderedMovieList(startPosition, numberOfMovies, orderType, lang);
    ...
    public void testMoviesOrderedByTitle() throws DAOException {
        ...
        int numberOfMovies = expectedMovieList.size();
        String lang = "en";
        String orderType = MovieValidator.OrderType.TITLE.toString();
    ...
    @Test
    public void testCountMovies() throws MovieCounterDAOException {
        int expected = 22;
        int actual = movieDAO.countMovies();
